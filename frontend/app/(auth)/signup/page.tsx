...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || "Registration failed. Verify entity details.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="border border-slate-200/80 rounded-2xl bg-white p-7 sm:p-9 shadow-xl shadow-slate-200/40">
            ...
            <div className="mb-6 text-left">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-slate-950">
                Register Entity Workspace
              </h1>
              <p className="text-xs text-slate-500 mt-1">
                Provision a multi-tenant vault for your Bank or NBFC branch.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    name="company_name"
                    placeholder="e.g. Apex Rural Bank Ltd."
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="compliance@institution.in"
                    value={form.email}
                    onChange={handleChange}
                    required
                    className="w-full pl-9 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:bg-white focus:ring-1 focus:ring-blue-600 focus:border-blue-600 transition-all font-medium"
              ...
              >
                {loading ? (
                  ...
                  <>
                    <span>Create Entity Workspace</span>
          ...
          <div className="mt-6 text-center">
            <p className="text-[11px] text-slate-400 font-medium inline-flex items-center gap-1.5">
              ...
              <span>Isolated Schema Encryption & RBI IRACP Compliant</span>
            </p>
          </div>
        </div>
      </main>
